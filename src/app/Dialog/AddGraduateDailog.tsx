      ...
      <DialogContent className="FormContainer p-0">
        ...
        <form className="SearchForm">
          <div className="AddFormBody AddGraduate gap-0">
            <div className="Row1 ">
              <label className="w-32"> الاسم الكامل :</label>
            ...
            <div className="Row2">
              <label className="w-32"> الجنسية :</label>
            ...
            <div className="Row3">
              <label className="w-32"> العنوان الحالي :</label>
            ...
            <div className="Row4">
              <label className="w-32"> تلفون : </label>
              <Input Placeholder={""} Name={""} />
              <label> الجوال </label>
              <Input Placeholder={""} Name={""} />
              <label> واتس اب </label>
            ...
            <div className="Row5 ">
              <label className="w-60 text-left">
                اسم الجامعة او الجهة التعليمية :
              </label>
              <Input Placeholder={""} Name={""}></Input>
              <label className="w-24  text-left"> الكلية :</label>
              <Input Placeholder={""} Name={""}></Input>
              <label className="w-32 text-left"> التخصص :</label>
              <Input Placeholder={""} Name={""}></Input>
            </div>
            <div className="Row6 ">
            <label className="w-60 text-left">درجة التخرج :</label>
              <SecondaryDropDown Trigger={""}>
                <label className="active">قطر</label>
                <label>الكويت</label>
                <label>مصر</label>
              </SecondaryDropDown>
              <label className="w-24 text-left"> سنة التخرج :</label>
              <Input Placeholder={""} Name={""}></Input>
              <label className="w-32 text-left"> المعدل التراكمي :</label>
              <Input Placeholder={""} Name={""}></Input>
            </div>
            <div className="Row7">
            <label className=" text-left"> التدريب العملي :</label>
              <TextArea
                Placeholder={
            ...
            <div className="Row8 ">
              <label className="text-left"> الخبرات السابقة :</label>
            ...
            <div className="Row9 ">
              <label className=" text-left"> صور الوثائق :</label>
              <FileInput InputName={""}/>
...
export default AddGraduateDailog
